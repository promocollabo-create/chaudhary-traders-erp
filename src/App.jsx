...
function InvoiceForm({ customers, products, drivers, bookings, invoices, payments, prefill, editingInvoice, currentUser, onSave, onCancel, nextNumber }) {
  ...
  const previousOutstanding = isEdit
    ...
    : selectedCustomer
    ? computeLedgerForCustomer(selectedCustomer, invoices, payments).outstanding
    : 0;
  ...
  function submit() {
    ...
    if (isEdit) {
      onSave({
        ...
        status: editingInvoice.docStatus === "Cancelled" ? editingInvoice.docStatus : base.status,
      });
    } else {
      onSave({
        id: uid("inv"),
...
function Invoices({ customers, products, drivers, invoices, payments, bookings, settings, currentUser, saveInvoice, updateInvoice, cancelInvoice, prefill, onClearPrefill, onBookingFulfilled, onOrderFulfilled }) {
