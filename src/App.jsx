...
function LedgerView({ customers, invoices, payments, focusId, setFocusId, settings }) {
...
export default function App() {
  ...
  const pages = {
    ...
    ledger: <LedgerView customers={visibleCustomers} invoices={visibleInvoices} payments={visiblePayments} focusId={ledgerFocusId} setFocusId={setLedgerFocusId} settings={settings} />,
